...
from compression.brief_context import BriefContextCompressor 
...
_COMPRESSION_REGISTRY: dict[CompressionStrategy, Callable[[BaseChatModel], BaseContextCompressor]] = {
    ...
    CompressionStrategy.BRIEF_CONTEXT:        lambda llm: BriefContextCompressor(llm, n_partitions=3),  # <-- NEW
}
